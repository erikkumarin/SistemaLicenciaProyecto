...
public class ControladorXml {
    ...
    public void importarXml(String cedula, int x) throws ErrorConexion {
        ...
        xml.generarInformacion(cliente.getCedula(), cliente.getNombre(), String.valueOf(cliente.calcularEdad()), cliente.getCorreo(),
                ...
                prueba.getObservaciones(), String.valueOf(x), oficial.getCedula(), oficial.getNombre(), oficial.getCorreo());
    }
